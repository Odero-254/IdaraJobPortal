...
<head>
	...
	<title>NYS Job Portal | Applicants <?php echo "$job_title"; ?></title>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Applicantions received for a post of <?php echo "$job_title"; ?></</h3>
						</div>
