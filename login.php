...
<head>
	...
	<title>NYS job portal | Login</title>
...
<button type="submit" class="btn btn-primary">Login</button>
				...
				<div class="modal-body">
					<div class="row gap-20">
						...
						<div class="col-sm-12 col-md-12">
							<p class="mb-20">Enter your account's email address, we will send you the link to reset your password</p>
						</div>
						...
						<div class="col-sm-12 col-md-12">
							<div class="login-box-box-action">
								Return to <a data-dismiss="modal">Login</a>
								<p id="data"></p>
							</div>
