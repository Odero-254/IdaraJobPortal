...
<head>
	...
	<title>NYS job portal | Home</title>
	<meta name="description" content="Online Job Management / Job Portal" />
	<meta name="keywords" content="job, work, resume, applicants, application, employee, employer, hire, hiring, human resource management, hr, online job management, company, worker, career, recruiting, recruitment" />
	<meta name="author" content="BenardOdero">
    ...
    <meta property="og:image:alt" content="NYS Job portal" />
...
<body class="home">
	...
	<div class="container-wrapper">
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employers.php">System Admin</a>
							</li>
							
							<li>
								<a href="employees.php">Ex-NYS S/M/W</a>
							</li>
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Register as NYS Dischargee</a>
						</div>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01(1).jpeg');">
				<div class="container">

					<h1>Just done with National Youth Service?</h1>
					<p>your bright future starts here now. <br> Finding your next job or career.</p>
			...
			<div class="bg-light pt-80 pb-80">
              ...
              <?php
					    ...
					    // Adding a condition to filter out expired dates
					    $currentDate = date("d-m-Y");
					    $stmt = $conn->prepare("SELECT * FROM tbl_jobs WHERE closing_date >= :currentDate ORDER BY enc_id DESC LIMIT 8");
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About NYS</h5>
											<p>NYS is a government disciplined service that trains, mentors and educates Kenyan youths to carry out task and duties assignd to them in future as well as be a ready resource for employment.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="employers.php">System Admin</a></li>
											<li><a href="employees.php">Ex-NYS S/M/W</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">NYS | Job portal Contact</h5>
								
								<p>Address : NYS Headquaters, Thika Road PO.BOX 30397-00100 Nairobi.</p>
								<p>Email : <a href="mailto:nyshqs@go.ke">nyshqs@go.ke</a></p>
								<p>Phone : <a href="tel:+254728005323">+254 728 005 323</a></p>
							</div>		
						</div>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> NATIONAL YOUTH SERVICE</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Benard Odero</a></li>
								</ul>
